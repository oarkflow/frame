...
// CopyToFrameRequest copy uri, host, method, protocol, header, but share body reader from http.Request to protocol.Request.
func CopyToFrameRequest(req *http.Request, hreq *protocol.Request) error {
