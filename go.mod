...
replace github.com/bytedance/go-tagexpr/v2 => github.com/sujit-baniya/go-tagexpr/v2 v2.9.13
...
require (
	...
	github.com/oarkflow/phonenumbers v1.2.7 // indirect
	github.com/oarkflow/pkg v0.1.22 // indirect
